...
def load_config():
    ...
    # override config with environment variables. Some online deployment platforms (e.g. Railway) deploy project from github
    # directly. So you shouldn't put your secrets like api key in a config file, instead use environment variables to
